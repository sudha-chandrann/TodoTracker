...
function Commentitem({ commentid, comment, user ,todoid , ondelete,onedit}) {
  ...
  const deletecomment=async()=>{
   try{
    const response = await axios.delete(`/api/comments/${todoid}/${commentid}`)
  ...
  const editcomment=async()=>{
     try{
    const response = await axios.patch(`/api/comments/${todoid}/${commentid}`,
        {
            newcomment
        }
    )
